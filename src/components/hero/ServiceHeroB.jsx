      ...
      <section className="solution__area" ref={solutionArea}>
        ...
        <div className="solution__wrapper">
          ...
          <div className="solution__mid">
            ...
            <p>
            Maximize your business potential with our Business Automation Service. We streamline operations by automating tasks like data entry, inventory management, customer service, and marketing. Our solutions cut costs, boost efficiency, and eliminate errors, allowing your team to focus on strategic growth. Let us handle the automation, so you can scale seamlessly
            </p>
          </div>
